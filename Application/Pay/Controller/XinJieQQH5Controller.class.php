...
class XinJieQQH5Controller extends PayController
{
    private $CODE = 'XinJieQQH5';
    private $TITLE = '信捷QQH5';
    ...
    public function Pay($array)
    {
        ...
        $resultjsonde = json_decode($result['1']);
            ...
            if($resultjsonde->retcode=="00"){
                //echo $resultjsonde->payInfo;
                header("Location:$resultjsonde->payInfo");
            }else{
