...
class GyAliSmController extends PayController{
	...
	public function Pay($array){
		...
		$notifyurl = $this->_site . 'Pay_QftAliSm_notifyurl.html';

		$callbackurl = $this->_site . 'Pay_QftAliSm_callbackurl.html';
    ...
    public function notifyurl(){
        ...
        if($data['pay_result'] == 0 && $respSign == $sign){
            $this->EditMoney($data["tradeSn"], 'GyAliSm', 0);
            exit('success');
        }
