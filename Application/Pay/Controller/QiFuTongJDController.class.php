 ...
 * 启付通-京东
 * 单笔限额 10-5000
 * Class QiFuTongJDController
 * @package Pay\Controller
 * @author 叶子龙
 */
class QiFuTongJDController extends PayController
{
    private $CODE = 'QiFuTongJD';
    private $TITLE = '启付通-京东';
    ...
    public function Pay($array)
    {
        ...
        $data = array(
            ...
            'currency'          => 'CNY',
            'goodsTitle'          => '电脑',
            'payType'           => "JDwallet", //交易类型: 微信H5 wechat_h5
            'appNo'             => $appid, //商户应用编号,
        ...
        //添加日记
        //通道返回数据"{"code":"000000","errMsg":null,"data":{"orderNo":"LJ2018040209521433018406","createTime":"20180402095215","payNo":"PAY201804020000525026","codeUrl":"https://h5pay.jd.com/code?c=5wjvchx05xsxm6","remark":null,"sign":"868ab15fe8e167d37a36ae46126d0ef2"}}"
