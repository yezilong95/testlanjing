...
/**
 * 稳付宝-银联扫码
 * Class WenFuBaoYinLianScanController
 * @package Pay\Controller
 * author 尚军邦
 */
class WenFuBaoYinLianScanController extends PayController
{
    //注：该接口支付跟异步通知使用的秘钥不同，异步通知的秘钥用后台appid ，order表中的参数account
    private $CODE = 'WenFuBaoYinLianScan';
    private $TITLE = '稳付宝-银联扫码';
