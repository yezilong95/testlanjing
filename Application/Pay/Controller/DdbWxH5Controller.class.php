...
class DdbWxH5Controller extends PayController
{
    ...
    public function Pay($array)
    {
        ...
        $notifyurl = $this->_site . 'Pay_DdbWxH5_notifyurl.html'; //异步通知
        $callbackurl = $this->_site . 'Pay_DdbWxH5_callbackurl.html'; //跳转通知
        $parameter = array(
            'code' => 'DdbWxH5', // 通道名称
            'title' => '微信H5支付-多得宝付', //通道名称
            'exchange' => 1, // 金额比例
            'gateway' => '',
            'orderid'=>'',
