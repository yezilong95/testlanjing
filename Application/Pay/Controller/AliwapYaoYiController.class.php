...
class AliwapYaoYiController extends PayController
{
    ...
    public function Pay($array)
    {
        ...
        $notifyurl = $this->_site . 'Pay_AliwapYaoYi_notifyurl.html'; //异步通知
        $callbackurl = $this->_site . 'Pay_AliwapYaoYi_callbackurl.html'; //返回通知
        $parameter = array(
            'code' => 'AliwapYaoYi', // 通道名称
            'title' => '支付宝-耀益',
            'exchange' => 1, // 金额比例
            'gateway' => '',
            'orderid' => '',
    ...
    protected function alipayWap($params){
        ...
        addSyslog('支付宝-耀益提交字符串:'.$sysParams);
    ...
    public function callbackurl()
    {
        ...
        //if($result){
            $this->EditMoney($response['out_trade_no'], 'AliwapYaoYi', 1);
        //}else{
    ...
    public function notifyurl()
    {
        ...
        //if($result){
            if($response['trade_status'] == 'TRADE_SUCCESS' || $response['trade_status'] == 'TRADE_FINISHED'){
                $this->EditMoney($response['out_trade_no'], 'AliwapYaoYi', 0);
