...
/**
 * 恒信智付-QQ扫码
 * Class HengXinQQScanController
 * @package Pay\Controller
 * @author 尚军邦
 */
class HengXinQQScanController extends PayController
{
    private $CODE = 'HengXinQQScan';
    private $TITLE = '恒信智付-QQ扫码';
