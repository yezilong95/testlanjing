 ...
 * @author 叶子龙
 */
class QiFuTongWangGuanNoController extends PayController
{
    private $CODE = 'QiFuTongWangGuanNo';
    private $TITLE = '启付通-网关不分PC/Web';
    ...
    public function Pay($array)
    {
        ...
        $this->display("CashierWangGuan/indexNo");
    }
