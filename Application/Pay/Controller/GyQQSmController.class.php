...
class GyQQSmController extends PayController{
	...
	public function Pay($array){
		...
		$notifyurl = $this->_site . 'Pay_GyQQSm_notifyurl.html';

		$callbackurl = $this->_site . 'Pay_GyQQSm_callbackurl.html';
    ...
    public function notifyurl(){
        ...
        if($data['pay_result'] == 0 && $respSign == $sign){
            $this->EditMoney($data["tradeSn"], 'GyQQSm', 0);
            exit('success');
        }
