 ...
 * @叶子龙
 */
class XinJieKJController extends PayController
{
    private $CODE = 'XinJieKJ';
    ...
    public function Pay($array)
    {
        ...
        $body = I('request.pay_productname','vip会员充值');
    ...
    public function callbackurl()
    {
        ...
        $channelOrderId = $_REQUEST['merchantOrderId'];
        ...
        //查找订单
        $orderModel = M("Order");
        $order = $orderModel->where(['channel_order_id' => $channelOrderId])->find();
        if(empty($order)){
