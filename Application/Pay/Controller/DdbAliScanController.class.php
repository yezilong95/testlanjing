...
class DdbAliScanController extends PayController
{
    ...
    public function Pay($array)
    {
        ...
        $notifyurl = $this->_site . 'Pay_DdbAliScan_notifyurl.html'; //异步通知
        $callbackurl = $this->_site . 'Pay_DdbAliScan_callbackurl.html'; //跳转通知
        $parameter = array(
            'code' => 'DdbAliScan', // 通道名称
            'title' => '支付宝扫码支付-多得宝付', //通道名称
            'exchange' => 1, // 金额比例
            'gateway' => '',
            'orderid'=>'',
