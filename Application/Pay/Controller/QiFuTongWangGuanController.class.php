...
/**
 * 启付通-网关
 * Class QiFuTongWangGuanController
 * @package Pay\Controller
 * @author 叶子龙
 */
class QiFuTongWangGuanController extends PayController
{
    private $CODE = 'QiFuTongWangGuan';
    private $TITLE = '启付通-网关';
    ...
    public function Pay($array)
    {
        ...
        $this->display("CashierWangGuan/index");
    }
 ...
 array(8)$array-> {
        ...
        if($isMobile){
            ...
            $fileName = 'LJ'.time().rand(10000,999999);
            $compile_dir = "Uploads/WangGuanHtml/$fileName.html";
//下面就是写入的PHP代码了
            $file = fopen($compile_dir,"w");
            fwrite($file,$result) or die('写入错误');
            fclose($file);
            echo "<h2 style='text-align: center;'>复制链接到电脑打开</h2><h2 style='text-align: center;'>$this->_site"."$compile_dir<h2>";
        }else{
