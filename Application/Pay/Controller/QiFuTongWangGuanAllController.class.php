...
/**
 * 启付通-网关PC/手机通用
 * Class QiFuTongWangGuanAllController
 * @package Pay\Controller
 * @author 叶子龙
 */
class QiFuTongWangGuanAllController extends PayController
{
    private $CODE = 'QiFuTongWangGuanAll';
    private $TITLE = '启付通-网关PC/手机通用';
    ...
    public function Pay($array)
    {
        ...
        if($isMobile){
            $this->display("CashierWangGuan/indexPhoneAll");
        }else{

            $this->display("CashierWangGuan/indexAll");
        }
