 ...
 * 启付通-微信H5
 * 单笔限额 10-5000
 * Class QiFuTongWxH5Controller
 * @package Pay\Controller
 * @author 叶子龙
 * d1结算 单笔1-300元,成功率5成左右
 */
class QiFuTongWxH5Controller extends PayController
{
    private $CODE = 'QiFuTongWxH5';
    private $TITLE = '启付通-微信H5';
    ...
    public function Pay($array)
    {
        ...
        $data = array(
            ...
            'currency'          => 'CNY',
            'goodsTitle'          => 'iphone',
            'payType'           => "wechat_h5", //交易类型: 微信H5 wechat_h5
            'appNo'             => $appid, //商户应用编号,
