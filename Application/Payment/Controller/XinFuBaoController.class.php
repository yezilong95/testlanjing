 ...
 * 尚军邦
 */
class XinFuBaoController extends PaymentController
{
    private $TITLE = '信付宝代付';
    ...
    public function PaymentExec($wttlList, $pfaList)
    {
        ...
        $data = [
            ...
            'rcvBranchCode'         => $bankSymbol['xfb_num'],
            'accBankName'         => $bankName,
            'accBankNo '         => $bankSymbol['xfb_num'],
            //'tranChannel' => '103',
            'payMode' => '00023',
            'note' => '银联代付',
            'cityname'=>'北京'
...
//    }
    ...
    public function PaymentQuery($wttlList, $pfaList)
    {
        ...
        if($returnData['retCode'] == '1' && $returnData['orderstatus'] == '01'){
            if($returnData['ordamt'] == $amount){
